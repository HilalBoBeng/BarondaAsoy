      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm">
         ...
         <CardFooter className="flex-col sm:flex-row gap-2">
            ...
            {schedule.status === 'In Progress' && <Button className="w-full" onClick={() => handleScan('end')} disabled={isSubmitting}><QrCode className="mr-2 h-4 w-4" /> Selesaikan Patroli</Button>}
