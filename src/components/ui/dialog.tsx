  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "overflow-hidden p-0 w-[90%] sm:max-w-lg rounded-lg flex flex-col", 
        className
      )}
      {...props}
    >
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex items-center justify-between space-y-0 bg-primary p-4 text-primary-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-primary-foreground/80", className)}
    {...props}
  />
))
...
const DialogBody = ({
    ...
    <div className={cn("p-6 flex-grow min-h-[200px]", className)} {...props} />
)
